...
resource "azurerm_virtual_machine" "virtual_machine1" {
  ...
  storage_os_disk {
    ...
    image_uri         = "https://packerexamples.blob.core.windows.net/system/Microsoft.Compute/Images/chicagodevops/packer-osDisk.ad0e1ef3-4d32-4e11-81ad-0debf6beb820.vhd"
  }
}