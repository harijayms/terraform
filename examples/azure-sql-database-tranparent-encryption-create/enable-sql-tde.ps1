...
$cred = New-Object System.Management.Automation.PSCredential($Env:ARM_CLIENT_ID, $password)

Add-AzureRmAccount -Credential $cred -TenantId $Env:ARM_TENANT_ID -ServicePrincipal
